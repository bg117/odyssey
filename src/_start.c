...
static volatile struct limine_framebuffer_request fb_request = {LIMINE_FRAMEBUFFER_REQUEST, 0};
static volatile struct limine_memmap_request mmap_request = {LIMINE_MEMMAP_REQUEST, 0};
static volatile struct limine_hhdm_request hhdm_request = {LIMINE_HHDM_REQUEST, 0};
...
__attribute__((noreturn)) void _start(void)
{
    ...
    // call init
    odyssey(fb, mmap_request.response->entries, mmap_request.response->entry_count, hhdm_request.response->offset);
